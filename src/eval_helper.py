...
def bulk_transform_dfs(df_list):
    ...
    for df in df_list:
        ...
        needed_columns = ['id', 'accuracy', 'logic', 'clarity', 'detail', 'irrelevance', 'plausibility']
...
def gen_question_prefix(TEST_NAME):
    ...
    plt.pie(question_prefixes.values(), labels=question_prefixes.keys(), autopct='%1.1f%%', startangle=140)
